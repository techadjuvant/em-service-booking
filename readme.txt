...
* Get notification when a booking order is placed along with the booking info
* Send pending booking notification with default admin message and booking info to the customer when a booking is placed
* Send notification on confirming or canceling the booking 
...
= Can I translate the EMSB Service Booking plugin? =
