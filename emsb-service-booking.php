<?php
/*
 * Plugin Name:	Doctor Appointment Booking Calendar - EMSB
 * Description: A complete plugin for booking appointments, reservations, orders, services, events, etc. Easiest, flexible, modern, 100% responsive and SEO friendly.
